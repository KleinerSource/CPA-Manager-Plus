...
export type PluginStoreInstallProgressType = 'progress' | 'installed' | 'error';

export interface PluginStoreInstallProgressEvent {
  type: PluginStoreInstallProgressType;
  stage: string;
  assetName: string;
  downloaded: number;
  total: number;
  ...
  error: string;
  restartRequired: boolean;
  result: PluginStoreInstallResult | null;
}
